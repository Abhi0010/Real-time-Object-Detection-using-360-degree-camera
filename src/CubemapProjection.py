...
class CubemapProjection(AbstractProjection):
  ...
  def getImages(self, front, right, back, left, top, bottom):
    images = []
    images.append(self._getImage(self.front, self.imsize))
    images.append(self._getImage(self.right, self.imsize))
    images.append(self._getImage(self.back, self.imsize))
    images.append(self._getImage(self.left, self.imsize))
    images.append(self._getImage(self.top, self.imsize))
    images.append(self._getImage(self.bottom, self.imsize))
    return images
